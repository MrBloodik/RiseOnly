import { colorValues } from '@shared/config/const';
import { getCustomizationSettingsBtns } from '@shared/config/group-btns-data';
import { CustomizationPreviewContent } from '@shared/config/tsx';
import { getCurrentRoute } from '@shared/lib/navigation';
import { BottomSheetUi, Box, GroupedBtns } from '@shared/ui';
...
export const CustomizationSettings = observer(() => {
	...
	const groupedBtns = useMemo(() => {
		return getCustomizationSettingsBtns(t);
	}, [t]);
