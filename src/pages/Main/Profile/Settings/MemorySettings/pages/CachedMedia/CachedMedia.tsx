...
import { Box, CleverImage, MainText, SecondaryText } from '@shared/ui';
	...
	return (
		<View style={styles.dataItem}>
			<View style={styles.dataHeader}>
				...
				<TouchableOpacity
					style={[styles.deleteButton, { backgroundColor: currentTheme.originalMainGradientColor.color }]}
								...
								return (
									<TouchableOpacity
										...
										style={[
											...
											{
												width: postInteractionsStore.GRID_POST_WIDTH,
												height: 150,
