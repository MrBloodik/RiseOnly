...
// Расширяем интерфейс WebView для добавления свойства isFocused
...
export const LexicalRichTextInput = forwardRef<LexicalRichTextInputRef, LexicalRichTextInputProps>(
  ({
    ...
    // Абсолютно минимальный HTML для редактора
    const htmlContent = `
      <!DOCTYPE html>
      <html>
        <head>
          ...
          <style>
            * {
            ...
            #editor {
              ...
              font-size: 14.5px;
              color: ${String(themeStore.currentTheme.textColor.color)};
              min-height: ${minHeight}px;
              max-height: ${maxHeight}px;
              overflow-y: auto;
              -webkit-overflow-scrolling: touch;
              outline: none;
              caret-color: ${String(themeStore.currentTheme.textColor.color)};
            }
            
            #editor:empty:before {
              content: "${placeholder}";
              color: ${String(placeholderTextColor || themeStore.currentTheme.secondTextColor.color)};
              position: absolute;
              pointer-events: none;
            }
            ...
            .code-block {
              background-color: ${changeRgbA(themeStore.currentTheme.originalMainGradientColor.color as string, "0.1")};
              ...
              margin: 5px 0;
              border: none;
              border-left: 3px solid ${String(themeStore.currentTheme.originalMainGradientColor.color)} !important;
              white-space: pre;
              line-height: 1.5;
            }
            ...
            .language-label {
              ...
              top: 5px;
              left: 5px;
              color: ${String(themeStore.currentTheme.originalMainGradientColor.color)};
              padding: 0px 5px;
              font-size: 10px;
              background-color: transparent;
            }
        ...
        <body>
          ...
          <script>
            // Абсолютно минимальная реализация редактора
            ...
            // Флаг для отслеживания, редактирует ли пользователь текст
            ...
            function syncContent() {
              ...
              // Отправляем содержимое только если оно изменилось
